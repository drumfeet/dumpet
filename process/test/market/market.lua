-- source: https://www.ao.link/#/entity/B8gLHTXexfNT-fbml6Mn1AV1HBPJJy2OYQQ3j3weK6Y?tab=source-code
...
Handlers.add('Balances', Handlers.utils.hasMatchingTag("Action", "Balances"), function(msg)
    if msg.reply then
        ...
        Send({ Target = msg.From, Data = json.encode(Balances) })
                ...
                MarketInfo = {
                    Title = "battle the best food",
                    Duration = "1732844100000",
                    TokenTxId = "QD3R6Qes15eQqIN_TK5s7ttawzAiX8ucYI2AUXnuS18",
                    OptionA = "burgers",
                    OptionB = "pizza",
                    ProcessId = "B8gLHTXexfNT-fbml6Mn1AV1HBPJJy2OYQQ3j3weK6Y",
                    Creator = "g0atl4vql8sc6dcqkzSfdkfQbjVxAV045wxXLsoul9E",
                    BlockHeight = "1556123",
                    Timestamp = "1732671527809",
                    Concluded = false,
                    AoTokenProcessId = "m3PaWzK4PTG9lAaqYQPaPdOcXdO8hYqi5Fe9NWqXd0w"
                    }
                Creator = "g0atl4vql8sc6dcqkzSfdkfQbjVxAV045wxXLsoul9E"
                Owner = ""
                MainProcessId = "jIRuxblllcBIDUmYbrbbEI90nJs40duNA6wR6NkYVvI"
